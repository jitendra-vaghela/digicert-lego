...
import (
	...
	"github.com/jitendra-vaghela/digicert-lego/v4/challenge/http01"
	"github.com/jitendra-vaghela/digicert-lego/v4/challenge/tlsalpn01"
	"github.com/jitendra-vaghela/digicert-lego/v4/lego"
	"github.com/jitendra-vaghela/digicert-lego/v4/log"
	"github.com/jitendra-vaghela/digicert-lego/v4/providers/dns"
	"github.com/jitendra-vaghela/digicert-lego/v4/providers/http/memcached"
	"github.com/jitendra-vaghela/digicert-lego/v4/providers/http/s3"
	"github.com/jitendra-vaghela/digicert-lego/v4/providers/http/webroot"
